package com.app.dodamdodam.service.chat;

import com.app.dodamdodam.entity.chat.ChatRoom;
import com.app.dodamdodam.entity.member.Member;
import com.app.dodamdodam.exception.ChatRoomNotFoundException;
import com.app.dodamdodam.repository.chat.ChatRoomRepository;
...
//        String joinedUserName = chatRoom.getUsers().put(userDetail.getId(), userDetail.getMemberId());
//
//        // 채팅 인원수 + 1
...
//    }
    @Transactional
    public String addUser(String roomId, Member member) {
        ChatRoom chatRoom = chatRoomRepository.findByRoomId(roomId).orElseThrow(ChatRoomNotFoundException::new);
        String joinedUserName = chatRoom.getUsers().put(member.getId(), member.getMemberId());
