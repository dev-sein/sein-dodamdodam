...
const buyTab = document.querySelector('.list6');
...
const projectList6 = document.querySelector('.project-list6');
...
function hideAllLists() {
  ...
  projectList6.style.display = 'none';
}
...
function handleEventTabClick() {
  hideAllLists();
  resetTabColors();
  projectList5.style.display = 'block';
  eventTab.style.color = '#006633;';
}

function handlebuyTabClick() {
  hideAllLists();
  resetTabColors();
  projectList6.style.display = 'block';
  buyTab.style.color = '#006633;';
}
...
eventTab.addEventListener('click', handleEventTabClick);
buyTab.addEventListener('click', handlebuyTabClick);
